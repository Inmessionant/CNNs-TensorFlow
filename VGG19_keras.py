# WI 指的是MSRA的何凯明的weight initial方法.-> kernel_initializer=he_normal()
#retrain + WI + BN + WD
...
dropout = 0.5
weight_decay = 0.0001
log_filepath = 'E:/Code/Backbone/vgg19_retrain/'
...
model.save('E:/Code/Backbone/models/vgg19_retrain.h5')
