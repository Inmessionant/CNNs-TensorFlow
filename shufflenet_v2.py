...
if __name__ == "__main__":
    ...
    print(len(vars))
    import numpy as np
    path = "E:/Code/Backbone/models/ShuffleNetV2-1x.npz"
    ...
    with tf.Session() as sess:
        ...
        sess.run(assign_ops)
        saver.save(sess, "E:/Code/Backbone/models/shufflene_v2_1.0.ckpt")
    ...
    img_path = 'E:/Code/Backbone/images/cat.png'
    ...
    with tf.Session() as sess:
        saver.restore(sess, "E:/Code/Backbone/models/shufflene_v2_1.0.ckpt")
